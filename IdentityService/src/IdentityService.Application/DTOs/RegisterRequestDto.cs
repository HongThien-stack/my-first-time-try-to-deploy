...
public class RegisterRequestDto
{
    ...
    [RegularExpression(@"^[A-Z](?=.*[a-z])(?=.*[!@#$%^&*(),.?""':;{}|<>_\-+=\[\]\\\/~`]).{5,}$", 
        ErrorMessage = "Password must start with an uppercase letter, contain at least one lowercase letter, and include at least one special character")]
