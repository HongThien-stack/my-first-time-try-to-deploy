...
BEGIN
    ...
    INSERT INTO sales (
        ...
        'SALE-2024-001',
        'S0000001-0001-0001-0001-000000000001', -- Cửa Hàng Thủ Đức
    ...
    (
        ...
        'SALE-2024-004',
        'S0000001-0001-0001-0001-000000000002', -- Cửa Hàng Quận 1
...
BEGIN
    ...
    (NEWID(), 'SALE0001-0001-0001-0001-000000000001', 'P0000001-0001-0001-0001-000000000005', N'Sữa Tươi Vinamilk 100%', 'SUA-001', '8934560003234', 2, 38000, 0);
    
    -- SALE-2024-002 items (Gạo ST25 × 2, Sữa TH × 1)
    INSERT INTO sale_items (id, sale_id, product_id, product_name, sku, barcode, quantity, unit_price, discount_amount) VALUES
    (NEWID(), 'SALE0001-0001-0001-0001-000000000002', 'P0000001-0001-0001-0001-000000000007', N'Gạo ST25', 'GAO-001', '8934560004234', 2, 180000, 36000),
    (NEWID(), 'SALE0001-0001-0001-0001-000000000002', 'P0000001-0001-0001-0001-000000000006', N'Sữa TH True Milk', 'SUA-002', '8934560003241', 1, 42000, 4200);
    
    -- SALE-2024-003 items (Cam Sành × 5 kg, Rau Muống × 2 kg)
    INSERT INTO sale_items (id, sale_id, product_id, product_name, sku, barcode, quantity, unit_price, discount_amount) VALUES
    (NEWID(), 'SALE0001-0001-0001-0001-000000000003', 'P0000001-0001-0001-0001-000000000003', N'Cam Sành', 'TC-001', '8934560002234', 5, 35000, 0),
    (NEWID(), 'SALE0001-0001-0001-0001-000000000003', 'P0000001-0001-0001-0001-000000000001', N'Rau Muống', 'RAU-001', '8934560001234', 2, 20000, 0);
    
    -- SALE-2024-004 items (Táo Envy × 1 kg, Sữa Vinamilk × 1)
    INSERT INTO sale_items (id, sale_id, product_id, product_name, sku, barcode, quantity, unit_price, discount_amount) VALUES
    (NEWID(), 'SALE0001-0001-0001-0001-000000000004', 'P0000001-0001-0001-0001-000000000004', N'Táo Envy', 'TC-002', '8934560002241', 1, 150000, 0),
    (NEWID(), 'SALE0001-0001-0001-0001-000000000004', 'P0000001-0001-0001-0001-000000000005', N'Sữa Tươi Vinamilk 100%', 'SUA-001', '8934560003234', 1, 35000, 0);
    
    -- SALE-2024-005 items (Gạo Jasmine × 2)
    INSERT INTO sale_items (id, sale_id, product_id, product_name, sku, barcode, quantity, unit_price, discount_amount) VALUES
    (NEWID(), 'SALE0001-0001-0001-0001-000000000005', 'P0000001-0001-0001-0001-000000000008', N'Gạo Jasmine', 'GAO-002', '8934560004241', 2, 140000, 0);
END
GO
