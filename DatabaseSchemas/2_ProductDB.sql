...
BEGIN
    ...
    ('P0000001-0001-0001-0001-000000000001', 'RAU-001', '8934560001234', N'Rau Muống', 
    ...
    ('P0000001-0001-0001-0001-000000000002', 'RAU-002', '8934560001241', N'Cải Thảo', 
     'C0000001-0001-0001-0001-000000000002', N'Đà Lạt', N'Việt Nam', 
    ...
    ('P0000001-0001-0001-0001-000000000003', 'TC-001', '8934560002234', N'Cam Sành', 
    ...
    ('P0000001-0001-0001-0001-000000000004', 'TC-002', '8934560002241', N'Táo Envy', 
    ...
    ('P0000001-0001-0001-0001-000000000005', 'SUA-001', '8934560003234', N'Sữa Tươi Vinamilk 100%', 
    ...
    ('P0000001-0001-0001-0001-000000000006', 'SUA-002', '8934560003241', N'Sữa TH True Milk', 
    ...
    ('P0000001-0001-0001-0001-000000000007', 'GAO-001', '8934560004234', N'Gạo ST25', 
    ...
    ('P0000001-0001-0001-0001-000000000008', 'GAO-002', '8934560004241', N'Gạo Jasmine', 
...
PRINT '';
PRINT 'Product IDs:';
PRINT '  - P0000001-0001-0001-0001-000000000001: Rau Muống (RAU-001)';
PRINT '  - P0000001-0001-0001-0001-000000000002: Cải Thảo (RAU-002)';
PRINT '  - P0000001-0001-0001-0001-000000000003: Cam Sành (TC-001)';
PRINT '  - P0000001-0001-0001-0001-000000000004: Táo Envy (TC-002)';
PRINT '  - P0000001-0001-0001-0001-000000000005: Sữa Vinamilk (SUA-001)';
PRINT '  - P0000001-0001-0001-0001-000000000006: Sữa TH (SUA-002)';
PRINT '  - P0000001-0001-0001-0001-000000000007: Gạo ST25 (GAO-001)';
PRINT '  - P0000001-0001-0001-0001-000000000008: Gạo Jasmine (GAO-002)';
PRINT '===============================================';
GO
