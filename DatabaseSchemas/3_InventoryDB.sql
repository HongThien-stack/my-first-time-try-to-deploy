...
BEGIN
    CREATE TABLE product_batches (
        ...
        CONSTRAINT FK_batches_slots FOREIGN KEY (slot_id) REFERENCES warehouse_slots(slot_id),
...
BEGIN
    ...
    ('W0000001-0001-0001-0001-000000000001', N'Kho Tổng HCM', N'Quận Thủ Đức, TP. Hồ Chí Minh', 120, 'ACTIVE', 
     '11111111-1111-1111-1111-111111111111', GETUTCDATE()),
    ('W0000001-0001-0001-0001-000000000002', N'Kho Miền Bắc', N'Quận Long Biên, Hà Nội', 100, 'ACTIVE', 
     '11111111-1111-1111-1111-111111111111', GETUTCDATE()),
    ('S0000001-0001-0001-0001-000000000001', N'Cửa Hàng Thủ Đức', N'123 Lê Văn Việt, Quận 9, HCM', 50, 'ACTIVE', 
     '22222222-2222-2222-2222-222222222221', GETUTCDATE()),
    ('S0000001-0001-0001-0001-000000000002', N'Cửa Hàng Quận 1', N'456 Nguyễn Huệ, Quận 1, HCM', 40, 'ACTIVE', 
     '22222222-2222-2222-2222-222222222221', GETUTCDATE());
END
GO
...
-- =====================================================
DECLARE @WarehouseId UNIQUEIDENTIFIER = 'W0000001-0001-0001-0001-000000000001';
...
BEGIN
    ...
    ('WS00001-0001-0001-0001-000000000001', @WarehouseId, 'A-01-01', 'A', 1, 1, 'OCCUPIED'),
    ('WS00001-0001-0001-0001-000000000002', @WarehouseId, 'A-01-02', 'A', 1, 2, 'OCCUPIED'),
    ('WS00001-0001-0001-0001-000000000003', @WarehouseId, 'A-02-01', 'A', 2, 1, 'OCCUPIED'),
    ('WS00001-0001-0001-0001-000000000004', @WarehouseId, 'B-01-01', 'B', 1, 1, 'EMPTY'),
    ('WS00001-0001-0001-0001-000000000005', @WarehouseId, 'B-01-02', 'B', 1, 2, 'EMPTY');
END
GO
...
BEGIN
    ...
    -- Warehouse inventory
    (NEWID(), 'P0000001-0001-0001-0001-000000000001', 'WAREHOUSE', 'W0000001-0001-0001-0001-000000000001', 500, 0, 50, 1000), -- Rau Muống
    (NEWID(), 'P0000001-0001-0001-0001-000000000002', 'WAREHOUSE', 'W0000001-0001-0001-0001-000000000001', 300, 0, 30, 800), -- Cải Thảo
    (NEWID(), 'P0000001-0001-0001-0001-000000000003', 'WAREHOUSE', 'W0000001-0001-0001-0001-000000000001', 800, 0, 100, 2000), -- Cam Sành
    (NEWID(), 'P0000001-0001-0001-0001-000000000005', 'WAREHOUSE', 'W0000001-0001-0001-0001-000000000001', 1000, 0, 200, 3000), -- Sữa Vinamilk
    (NEWID(), 'P0000001-0001-0001-0001-000000000007', 'WAREHOUSE', 'W0000001-0001-0001-0001-000000000001', 200, 0, 20, 500), -- Gạo ST25
    
    -- Store inventory (Cửa Hàng Thủ Đức)
    (NEWID(), 'P0000001-0001-0001-0001-000000000001', 'STORE', 'S0000001-0001-0001-0001-000000000001', 50, 0, 10, 100), -- Rau Muống
    (NEWID(), 'P0000001-0001-0001-0001-000000000003', 'STORE', 'S0000001-0001-0001-0001-000000000001', 80, 0, 20, 150), -- Cam Sành
    (NEWID(), 'P0000001-0001-0001-0001-000000000005', 'STORE', 'S0000001-0001-0001-0001-000000000001', 100, 0, 30, 200), -- Sữa Vinamilk
    (NEWID(), 'P0000001-0001-0001-0001-000000000007', 'STORE', 'S0000001-0001-0001-0001-000000000001', 15, 0, 5, 50); -- Gạo ST25
END
GO
...
BEGIN
    ...
    ('BATCH001-0001-0001-0001-000000000001', 'P0000001-0001-0001-0001-000000000005', 'W0000001-0001-0001-0001-000000000001', 
     'WS00001-0001-0001-0001-000000000001', 'VNM-2024-001', 500, '2024-02-01', '2024-08-01', 'Vinamilk Co.', '2024-02-05', 'AVAILABLE'),
    ('BATCH002-0001-0001-0001-000000000002', 'P0000001-0001-0001-0001-000000000006', 'W0000001-0001-0001-0001-000000000001', 
     'WS00001-0001-0001-0001-000000000002', 'TH-2024-001', 500, '2024-02-01', '2024-08-01', 'TH True Milk Co.', '2024-02-05', 'AVAILABLE'),
    ('BATCH003-0001-0001-0001-000000000003', 'P0000001-0001-0001-0001-000000000007', 'W0000001-0001-0001-0001-000000000001', 
     'WS00001-0001-0001-0001-000000000003', 'ST25-2024-001', 200, '2024-01-15', '2025-01-15', 'ST25 Co.', '2024-01-20', 'AVAILABLE');
END
GO
...
BEGIN
    ...
    ('SM00001-0001-0001-0001-000000000001', 'SM-2024-001', 'INBOUND', 'W0000001-0001-0001-0001-000000000001', 'WAREHOUSE', 
     '2024-02-05', 'Vinamilk Co.', 'PO-2024-001', '44444444-4444-4444-4444-444444444441', 'COMPLETED', N'Received 500 units of milk'),
    ('SM00001-0001-0001-0001-000000000002', 'SM-2024-002', 'INBOUND', 'W0000001-0001-0001-0001-000000000001', 'WAREHOUSE', 
...
BEGIN
    ...
    ('TRF0001-0001-0001-0001-000000000001', 'TRF-2024-001', 'WAREHOUSE', 'W0000001-0001-0001-0001-000000000001', 
     'STORE', 'S0000001-0001-0001-0001-000000000001', '2024-03-01', '2024-03-02', 'DELIVERED', 
...
BEGIN
    DECLARE @TransferId UNIQUEIDENTIFIER = 'TRF0001-0001-0001-0001-000000000001';
    ...
    (NEWID(), @TransferId, 'P0000001-0001-0001-0001-000000000005', 'BATCH001-0001-0001-0001-000000000001', 100, 100, 98, 2),
    (NEWID(), @TransferId, 'P0000001-0001-0001-0001-000000000007', 'BATCH003-0001-0001-0001-000000000003', 20, 20, 20, 0);
END
GO
...
BEGIN
    ...
    ('RST0001-0001-0001-0001-000000000001', 'RST-2024-001', 'S0000001-0001-0001-0001-000000000001', 'W0000001-0001-0001-0001-000000000001', 
     '33333333-3333-3333-3333-333333333331', '2024-03-01', 'NORMAL', 'COMPLETED', N'Weekly restock'),
    ('RST0001-0001-0001-0001-000000000002', 'RST-2024-002', 'S0000001-0001-0001-0001-000000000001', 'W0000001-0001-0001-0001-000000000001', 
...
BEGIN
    DECLARE @RestockId1 UNIQUEIDENTIFIER = 'RST0001-0001-0001-0001-000000000001';
    DECLARE @RestockId2 UNIQUEIDENTIFIER = 'RST0001-0001-0001-0001-000000000002';
    ...
    (NEWID(), @RestockId1, 'P0000001-0001-0001-0001-000000000005', 100, 25, 100, N'Low stock'),
    (NEWID(), @RestockId1, 'P0000001-0001-0001-0001-000000000007', 20, 5, 20, N'Low stock'),
    (NEWID(), @RestockId2, 'P0000001-0001-0001-0001-000000000005', 150, 15, NULL, N'Urgent - below threshold');
END
GO
