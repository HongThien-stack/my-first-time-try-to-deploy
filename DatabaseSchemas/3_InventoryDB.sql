...
BEGIN
    ...
    ('AA00001-0001-0001-0001-000000000001', @WarehouseId, 'A-01-01', 'A', 1, 1, 'OCCUPIED'),
    ('AA00001-0001-0001-0001-000000000002', @WarehouseId, 'A-01-02', 'A', 1, 2, 'OCCUPIED'),
    ('AA00001-0001-0001-0001-000000000003', @WarehouseId, 'A-02-01', 'A', 2, 1, 'OCCUPIED'),
    ('AA00001-0001-0001-0001-000000000004', @WarehouseId, 'B-01-01', 'B', 1, 1, 'EMPTY'),
    ('AA00001-0001-0001-0001-000000000005', @WarehouseId, 'B-01-02', 'B', 1, 2, 'EMPTY');
END
GO
...
BEGIN
    ...
    -- Warehouse inventory
    (NEWID(), 'P0000001-0001-0001-0001-000000000001', 'WAREHOUSE', 'A0000001-0001-0001-0001-000000000001', 500, 0, 50, 1000), -- Rau Muống
    (NEWID(), 'P0000001-0001-0001-0001-000000000002', 'WAREHOUSE', 'A0000001-0001-0001-0001-000000000001', 300, 0, 30, 800), -- Cải Thảo
    (NEWID(), 'P0000001-0001-0001-0001-000000000003', 'WAREHOUSE', 'A0000001-0001-0001-0001-000000000001', 800, 0, 100, 2000), -- Cam Sành
    (NEWID(), 'P0000001-0001-0001-0001-000000000005', 'WAREHOUSE', 'A0000001-0001-0001-0001-000000000001', 1000, 0, 200, 3000), -- Sữa Vinamilk
    (NEWID(), 'P0000001-0001-0001-0001-000000000007', 'WAREHOUSE', 'A0000001-0001-0001-0001-000000000001', 200, 0, 20, 500), -- Gạo ST25
    
    -- Store inventory (Cửa Hàng Thủ Đức)
    (NEWID(), 'P0000001-0001-0001-0001-000000000001', 'STORE', 'B0000001-0001-0001-0001-000000000001', 50, 0, 10, 100), -- Rau Muống
    (NEWID(), 'P0000001-0001-0001-0001-000000000003', 'STORE', 'B0000001-0001-0001-0001-000000000001', 80, 0, 20, 150), -- Cam Sành
    (NEWID(), 'P0000001-0001-0001-0001-000000000005', 'STORE', 'B0000001-0001-0001-0001-000000000001', 100, 0, 30, 200), -- Sữa Vinamilk
    (NEWID(), 'P0000001-0001-0001-0001-000000000007', 'STORE', 'B0000001-0001-0001-0001-000000000001', 15, 0, 5, 50); -- Gạo ST25
END
GO
...
BEGIN
    ...
    ('BA00001-0001-0001-0001-000000000001', 'P0000001-0001-0001-0001-000000000005', 'A0000001-0001-0001-0001-000000000001', 
     'AA00001-0001-0001-0001-000000000001', 'VNM-2024-001', 500, '2024-02-01', '2024-08-01', 'Vinamilk Co.', '2024-02-05', 'AVAILABLE'),
    ('BA00002-0001-0001-0001-000000000002', 'P0000001-0001-0001-0001-000000000006', 'A0000001-0001-0001-0001-000000000001', 
     'AA00001-0001-0001-0001-000000000002', 'TH-2024-001', 500, '2024-02-01', '2024-08-01', 'TH True Milk Co.', '2024-02-05', 'AVAILABLE'),
    ('BA00003-0001-0001-0001-000000000003', 'P0000001-0001-0001-0001-000000000007', 'A0000001-0001-0001-0001-000000000001', 
     'AA00001-0001-0001-0001-000000000003', 'ST25-2024-001', 200, '2024-01-15', '2025-01-15', 'ST25 Co.', '2024-01-20', 'AVAILABLE');
END
GO
...
BEGIN
    ...
    ('CA00001-0001-0001-0001-000000000001', 'SM-2024-001', 'INBOUND', 'A0000001-0001-0001-0001-000000000001', 'WAREHOUSE', 
     '2024-02-05', 'Vinamilk Co.', 'PO-2024-001', '44444444-4444-4444-4444-444444444441', 'COMPLETED', N'Received 500 units of milk'),
    ('CA00001-0001-0001-0001-000000000002', 'SM-2024-002', 'INBOUND', 'A0000001-0001-0001-0001-000000000001', 'WAREHOUSE', 
...
BEGIN
    ...
    ('DA00001-0001-0001-0001-000000000001', 'TRF-2024-001', 'WAREHOUSE', 'A0000001-0001-0001-0001-000000000001', 
...
BEGIN
    DECLARE @TransferId UNIQUEIDENTIFIER = 'DA00001-0001-0001-0001-000000000001';
    ...
    (NEWID(), @TransferId, 'P0000001-0001-0001-0001-000000000005', 'BA00001-0001-0001-0001-000000000001', 100, 100, 98, 2),
    (NEWID(), @TransferId, 'P0000001-0001-0001-0001-000000000007', 'BA00003-0001-0001-0001-000000000003', 20, 20, 20, 0);
END
GO
...
BEGIN
    ...
    ('EA00001-0001-0001-0001-000000000001', 'RST-2024-001', 'B0000001-0001-0001-0001-000000000001', 'A0000001-0001-0001-0001-000000000001', 
     '33333333-3333-3333-3333-333333333331', '2024-03-01', 'NORMAL', 'COMPLETED', N'Weekly restock'),
    ('EA00001-0001-0001-0001-000000000002', 'RST-2024-002', 'B0000001-0001-0001-0001-000000000001', 'A0000001-0001-0001-0001-000000000001', 
...
BEGIN
    DECLARE @RestockId1 UNIQUEIDENTIFIER = 'EA00001-0001-0001-0001-000000000001';
    DECLARE @RestockId2 UNIQUEIDENTIFIER = 'EA00001-0001-0001-0001-000000000002';
