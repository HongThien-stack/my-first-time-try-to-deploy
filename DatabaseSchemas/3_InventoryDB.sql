    ...
    -- =====================================================
    IF NOT EXISTS (SELECT * FROM inventories WHERE product_id = 'F0000001-0001-0001-0001-000000000001' AND location_id = 'A0000001-0001-0001-0001-000000000001')
        ...
        VALUES (NEWID(), 'F0000001-0001-0001-0001-000000000001', 'WAREHOUSE', 'A0000001-0001-0001-0001-000000000001', 500, 0, 50, 1000); -- Rau Muống
    IF NOT EXISTS (SELECT * FROM inventories WHERE product_id = 'F0000001-0001-0001-0001-000000000002' AND location_id = 'A0000001-0001-0001-0001-000000000001')
        INSERT INTO inventories (id, product_id, location_type, location_id, quantity, reserved_quantity, min_stock_level, max_stock_level)
        VALUES (NEWID(), 'F0000001-0001-0001-0001-000000000002', 'WAREHOUSE', 'A0000001-0001-0001-0001-000000000001', 300, 0, 30, 800); -- Cải Thảo
    IF NOT EXISTS (SELECT * FROM inventories WHERE product_id = 'F0000001-0001-0001-0001-000000000003' AND location_id = 'A0000001-0001-0001-0001-000000000001')
        INSERT INTO inventories (id, product_id, location_type, location_id, quantity, reserved_quantity, min_stock_level, max_stock_level)
        VALUES (NEWID(), 'F0000001-0001-0001-0001-000000000003', 'WAREHOUSE', 'A0000001-0001-0001-0001-000000000001', 800, 0, 100, 2000); -- Cam Sành
    IF NOT EXISTS (SELECT * FROM inventories WHERE product_id = 'F0000001-0001-0001-0001-000000000005' AND location_id = 'A0000001-0001-0001-0001-000000000001')
        INSERT INTO inventories (id, product_id, location_type, location_id, quantity, reserved_quantity, min_stock_level, max_stock_level)
        VALUES (NEWID(), 'F0000001-0001-0001-0001-000000000005', 'WAREHOUSE', 'A0000001-0001-0001-0001-000000000001', 1000, 0, 200, 3000); -- Sữa Vinamilk
    IF NOT EXISTS (SELECT * FROM inventories WHERE product_id = 'F0000001-0001-0001-0001-000000000007' AND location_id = 'A0000001-0001-0001-0001-000000000001')
        INSERT INTO inventories (id, product_id, location_type, location_id, quantity, reserved_quantity, min_stock_level, max_stock_level)
        VALUES (NEWID(), 'F0000001-0001-0001-0001-000000000007', 'WAREHOUSE', 'A0000001-0001-0001-0001-000000000001', 200, 0, 20, 500); -- Gạo ST25

    -- Store inventory (Cửa Hàng Thủ Đức)
    IF NOT EXISTS (SELECT * FROM inventories WHERE product_id = 'F0000001-0001-0001-0001-000000000001' AND location_id = 'B0000001-0001-0001-0001-000000000001')
        INSERT INTO inventories (id, product_id, location_type, location_id, quantity, reserved_quantity, min_stock_level, max_stock_level)
        VALUES (NEWID(), 'F0000001-0001-0001-0001-000000000001', 'STORE', 'B0000001-0001-0001-0001-000000000001', 50, 0, 10, 100); -- Rau Muống
    IF NOT EXISTS (SELECT * FROM inventories WHERE product_id = 'F0000001-0001-0001-0001-000000000003' AND location_id = 'B0000001-0001-0001-0001-000000000001')
        INSERT INTO inventories (id, product_id, location_type, location_id, quantity, reserved_quantity, min_stock_level, max_stock_level)
        VALUES (NEWID(), 'F0000001-0001-0001-0001-000000000003', 'STORE', 'B0000001-0001-0001-0001-000000000001', 80, 0, 20, 150); -- Cam Sành
    IF NOT EXISTS (SELECT * FROM inventories WHERE product_id = 'F0000001-0001-0001-0001-000000000005' AND location_id = 'B0000001-0001-0001-0001-000000000001')
        INSERT INTO inventories (id, product_id, location_type, location_id, quantity, reserved_quantity, min_stock_level, max_stock_level)
        VALUES (NEWID(), 'F0000001-0001-0001-0001-000000000005', 'STORE', 'B0000001-0001-0001-0001-000000000001', 100, 0, 30, 200); -- Sữa Vinamilk
    IF NOT EXISTS (SELECT * FROM inventories WHERE product_id = 'F0000001-0001-0001-0001-000000000007' AND location_id = 'B0000001-0001-0001-0001-000000000001')
        INSERT INTO inventories (id, product_id, location_type, location_id, quantity, reserved_quantity, min_stock_level, max_stock_level)
        VALUES (NEWID(), 'F0000001-0001-0001-0001-000000000007', 'STORE', 'B0000001-0001-0001-0001-000000000001', 15, 0, 5, 50); -- Gạo ST25
    GO
